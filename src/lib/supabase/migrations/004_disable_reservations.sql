-- Disable reservation system - only use stock_quantity for availability checks
-- This simplifies the system to prevent any issues with reserved quantities not clearing

-- Simplified reserve_inventory that doesn't actually reserve anything
-- Just checks if stock is available
...
-- Simplified finalize_order that directly deducts from stock
...
-- Clear all existing reservations and reset reserved quantities to 0
